...
pyArchOps/dnsmasq could always use more documentation, whether as part of the
official pyArchOps/dnsmasq docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `pyarchops/dnsmasq` repo on GitHub.
...
3. The pull request should work for Python 3.7. Check
   https://gitlab.com/pyarchops/dnsmasq/pipelines
